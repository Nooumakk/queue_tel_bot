...
response_en_monitoring = {
    ...
    "ЗО Бенякони": "WA Benyakoni",
    "ЗО Берестовица": "WA Berestovitsa",
    "ЗО Брест БТС": "WA Brest",
    "ЗО Григоровщина": "WA Grigorovshchina",
    "ЗО Каменный лог": "WA Kamenny Log",
    "ЗО Котловка": "WA Kotlovka",
    "ЗО Урбаны": "WA Urbany",
...
response_pl_monitoring = {
    ...
    "ЗО Бенякони": "ZO Bieniakoni",
    "ЗО Берестовица": "ZO Berestowica",
    "ЗО Брест БТС": "ZO Brest",
    "ЗО Григоровщина": "ZO Grigorowszczina",
    "ЗО Каменный лог": "ZO Kamenny Log",
    "ЗО Котловка": "ZO Kotlowka",
    "ЗО Урбаны": "ZO Urbany",
